...
public class UserDTO {
    ...
    @JsonSerialize
    @JsonDeserialize
    private List<EvolucionPaciente> evolucionPacientes;
    ...
    public UserDTO(User user) {
        ...
        this.numeroHistoria = user.getNumeroHistoria();
    ...
    public List<EvolucionPaciente> getEvolucionPacientes() {
        return evolucionPacientes;
    }

    public void setEvolucionPacientes(List<EvolucionPaciente> evolucionPacientes) {
        this.evolucionPacientes = evolucionPacientes;
    }
}
